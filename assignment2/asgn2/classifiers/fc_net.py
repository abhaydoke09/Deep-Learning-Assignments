...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None):
    ...
    ############################################################################
    out1,cache = affine_forward(X,self.params['W1'],self.params['b1'])
    relu1,cache = relu_forward(out1)
    scores,cache = affine_forward(relu1,self.params['W2'],self.params['b2'])
    ...
    dx,grads['W2'],grads['b2'] = affine_backward(dx,(relu1,self.params['W2'],self.params['b2']))
    dx = relu_backward(dx,out1)
    dx,grads['W1'],grads['b1'] = affine_backward(dx,(X,self.params['W1'],self.params['b1']))    
...
class FullyConnectedNet(object):
  ...
  self.params dictionary and will be learned using the   class.
  """
